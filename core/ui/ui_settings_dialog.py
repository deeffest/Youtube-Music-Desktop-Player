...
"}")
        ...
        self.verticalLayout_22 = QtWidgets.QVBoxLayout(self.SettingBox12)
        ...
        self.BodyLabel_29 = BodyLabel(self.SettingBox12)
        self.BodyLabel_29.setWordWrap(True)
        self.BodyLabel_29.setObjectName("BodyLabel_29")
        self.verticalLayout_22.addWidget(self.BodyLabel_29)
...
"}")
        ...
        self.SettingBox16.setFrameShadow(QtWidgets.QFrame.Raised)
        self.SettingBox16.setObjectName("SettingBox16")
        self.verticalLayout_25 = QtWidgets.QVBoxLayout(self.SettingBox16)
        self.verticalLayout_25.setObjectName("verticalLayout_25")
        self.horizontalLayout_20 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_20.setObjectName("horizontalLayout_20")
        self.label_11 = QtWidgets.QLabel(self.SettingBox16)
        ...
        self.BodyLabel_25 = BodyLabel(self.SettingBox16)
        ...
        self.SwitchButton_16 = SwitchButton(self.SettingBox16)
        ...
        self.BodyLabel_32 = BodyLabel(self.SettingBox16)
        ...
        self.verticalLayout_16.addWidget(self.SettingBox16)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.BodyLabel_33.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">When enabled, the window will be able to open the track in full screen mode.</span></p></body></html>"))
        ...
        self.BodyLabel_19.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">When enabled, all detected ads are immediately skipped. (useless with premium).</span></p></body></html>"))
        self.BodyLabel_12.setText(_translate("SettingsDialog", "Discord Rich Presence"))
        self.BodyLabel_26.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">When enabled, your Discord profile shows the current track’s title, artist, and cover art. (Discord must be running.)</span></p></body></html>"))
        self.BodyLabel_18.setText(_translate("SettingsDialog", "Windows Thumbnail Buttons"))
        self.BodyLabel_27.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">When enabled, media controls (Volume, Back, Play/Pause, Forward) appear on the app thumbnail in the taskbar.</span></p></body></html>"))
        self.BodyLabel_20.setText(_translate("SettingsDialog", "System Tray App Icon"))
        self.BodyLabel_28.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">When enabled, the app minimizes to a taskbar icon when closed and keeps playing in the background.</span></p></body></html>"))
        self.BodyLabel_21.setText(_translate("SettingsDialog", "Track Change Notificator"))
        self.BodyLabel_29.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">When enabled, a notification with the track\'s title and artist appears on each track change.</span></p></body></html>"))
