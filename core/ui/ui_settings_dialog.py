...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -1260, 374, 1587))
...
"}")
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.BodyLabel_35.setText(_translate("SettingsDialog", "<html><head/><body><p><span style=\" color:#808080;\">Hides the mini player when closing the player page. (useless with premium)</span></p></body></html>"))
