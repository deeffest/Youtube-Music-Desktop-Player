...
"FluentLabelBase{color:lightgray}")
        ...
        self.volume_down_button = TransparentToolButton(MiniPlayerDialog)
        self.volume_down_button.setMinimumSize(QtCore.QSize(40, 40))
        self.volume_down_button.setMaximumSize(QtCore.QSize(40, 40))
        self.volume_down_button.setIconSize(QtCore.QSize(20, 20))
        self.volume_down_button.setObjectName("volume_down_button")
        self.horizontalLayout_3.addWidget(self.volume_down_button)
        ...
        self.volume_up_button = TransparentToolButton(MiniPlayerDialog)
        self.volume_up_button.setMinimumSize(QtCore.QSize(40, 40))
        self.volume_up_button.setMaximumSize(QtCore.QSize(40, 40))
        self.volume_up_button.setIconSize(QtCore.QSize(20, 20))
        self.volume_up_button.setObjectName("volume_up_button")
        self.horizontalLayout_3.addWidget(self.volume_up_button)
