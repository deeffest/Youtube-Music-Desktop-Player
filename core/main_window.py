...
class MainWindow(QMainWindow):
    ...
    def video_state_changed(self, state):
        ...
        self.update_win_thumbnail_buttons_ui()
        self.update_tray_icon_ui()

    def update_tray_icon_ui(self):
    ...
    def update_win_thumbnail_buttons_ui(self):
