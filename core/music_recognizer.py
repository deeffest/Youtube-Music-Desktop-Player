...
class MusicRecognizerThread(QThread):
    ...
    recognizing_via_audd_api_error = Signal(int, str, str)
    recognizing_via_audd_api_success = Signal(str, str)

    recognizing_via_shazam_api = Signal()
    recognizing_via_shazam_api_error = Signal(int, str, str)
    recognizing_via_shazam_api_success = Signal(str, str)
